...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: dcoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: dcoind.pid)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 1777 or testnet: 11777)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Dcoin Wiki for SSL setup instructions)") + "\n" +
